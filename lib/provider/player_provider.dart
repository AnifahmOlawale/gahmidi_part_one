    ...
    if (_loopIcon == LoopPlayer.start) {
      ...
      if (currentPosition <= _loopStart) {
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(
            content: Text("Stope position should be greater"),
...
//NEXT
  void next() {
    int nextIndex =
        _currentPlayerIndex == 17 ? 0 : _currentPlayerIndex! + 1; //TODO
...
//PREVIOUSE
  void previous() {
    int previousIndex =
        _currentPlayerIndex == 0 ? 17 : _currentPlayerIndex! - 1; //TODO
...
//SHUFFLE
  void shuffle() {
    int randomIndex = random.nextInt(18); //TODO
